...
For more information, visit http://www.fenicsproject.org.
    ...
    version('2017.2.0', git='https://bitbucket.org/fenics-project/instant', tag='2017.2.0')
    version('2017.1.0', git='https://bitbucket.org/fenics-project/instant', tag='2017.1.0')
