...
class Dolfin(CMakePackage):
    ...
    version('2017.2.0', git='https://bitbucket.org/fenics-project/dolfin', tag='2017.2.0')
    version('2017.1.0', git='https://bitbucket.org/fenics-project/dolfin', tag='2017.1.0')
    ...
    for ver in ['@2017.2.0','@2017.1.0','@2016.1.0','@1.7.0dev','@1.6.0'] :
        depends_on('fiat{0}'.format(ver), type=("build","run"), when=ver)
        depends_on('instant{0}'.format(ver), type=("build","run"), when=ver)
        depends_on('dijitso{0}'.format(ver), type=("build","run"), when=ver)
    ...
    depends_on('vtk', when='@2016.0.0:+vtk')
    depends_on('vtk@5.10.1', when='@:1.8+vtk')
