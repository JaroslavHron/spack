...
class Mshr(CMakePackage):
    ...
    version('2017.2.0', git='https://bitbucket.org/fenics-project/mshr', tag='2017.2.0')
    version('2017.1.0', git='https://bitbucket.org/fenics-project/mshr', tag='2017.1.0')
    ...
    for ver in ['@2017.2.0','@2017.1.0','@2016.2.0','@2016.1.0','@1.7.0dev','@1.6.0'] :
